        ...
        public void Apply(Operation operation, OperationFilterContext context) {
            ...
            if (!fileParamNames.Any()) {
                ...
                foreach (var parameter in operation.Parameters.OfType<NonBodyParameter>()) {
                    ...
                    if (parameter.Default == null) parameter.Default = description.RouteInfo.DefaultValue;
            ...
            foreach (var param in operation.Parameters)
                paramsToRemove.AddRange(from fileParamName in fileParamNames
            ...
            foreach (var param in operation.Parameters) param.In = "formData";
